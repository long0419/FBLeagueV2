...
- (void)setupViewWithexcelView:(YHExcelView *)excelView indexPath:(NSIndexPath *)indexPath colViewPool:(NSMutableArray *)colViewPool{
    ...
    NSInteger columnCount = [excelView.dataSource excelView:excelView columnCountAtIndexPath:indexPath];
...
- (void)layoutSubviews {
    ...
    if (self.excelView && [self.excelView.dataSource respondsToSelector:@selector(excelView:widthForColumnAtIndex:)]){
