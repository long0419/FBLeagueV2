...
+ (void)setupConfigurationTemplate {
    ...
    QMUICMI.tabBarBackgroundImage = [UIImage qmui_imageWithColor:UIColorMake(249, 249, 249)];
    QMUICMI.tabBarShadowImageColor = UIColorSeparator;
    QMUICMI.tabBarTintColor = UIColorBlack ;
//    UIColorMake(4, 189, 231);
    QMUICMI.tabBarItemTitleColor = UIColorGray6;
