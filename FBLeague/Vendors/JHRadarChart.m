...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.speraLineColor = [UIColor colorWithWhite:0.5 alpha:0.3];
        self.perfectNumber = 100.0;
        self.descTextFont = [UIFont systemFontOfSize:13];
        self.descTextColor = [UIColor colorWithHexString:@"818a91" andAlpha:1];
    }
