...
@interface HuResultListViewController (){
    YYCache *cache ;
    UserDataVo *uvo ;
    NSString *pageNO ;
...
@implementation HuResultListViewController
...
- (void)viewDidLoad {
    ...
    __weak HuResultListViewController *weakSelf = self ;
