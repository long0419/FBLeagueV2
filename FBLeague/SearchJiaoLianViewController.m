...
//    headerBar.backgroundColor = [UIColor colorWithHexString:@"2eb66a"];
...
//    [[searchBar layer]setCornerRadius:12];//圆角
//    searchBar.backgroundColor=[UIColor colorWithHexString:@"000000" andAlpha:.2];
//    [headerBar addSubview:searchBar];
//    
//    UIImageView *soPic = [[UIImageView alloc] initWithFrame:CGRectMake(8 , (searchBar.height - 16)/2, 16, 16)] ;
//    [soPic setImage :[UIImage imageNamed:@"sopic"]];
...
//    UIColor *color = [UIColor colorWithHexString:@"fffffff" andAlpha:.4];
...
//    searchTxt.textColor = [UIColor colorWithHexString:@"ffffff"];
...
//    [client requestJsonDataWithPath:getCoachesByCity withParams:params withMethodType:Post andBlock:^(id data, NSError *error) {
//        if([data[@"code"] isEqualToString:@"0000"]){
//            NSDictionary *list = data[@"coaches"];
//            CoachVo *model = nil ;
...
//
//    JiaoLianDetailViewController *detail = [[JiaoLianDetailViewController alloc] init];
